...
public class FileServer {
	...
	final static String workingDir = "C:\\FileServer\\FileServer2";
	final static String serverName = new String("FileServer2");
	...
	public static void main(String[] args) {
		...
		registerServer();
		/*
		 * for (FileMetaServerDataBean temp : listOfFiles) {
		 * System.out.println(temp.getFileName());
		 * System.out.println(temp.getServerName()); }
		 */
	}
